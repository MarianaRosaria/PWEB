function confirmar(){
    ...
    switch (y) {
        ...
        case 4:
            novaJanela.document.writeln("<p>Coordenação: Prof. Dra. Suellen Signer Bartolomei</p>");
            novaJanela.document.writeln("<p>Carga horária Noturno: 2.880 horas</p>");
